...
#
# Script generated by Vivado on Sun Mar 23 22:00:49 +0100 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : FPGA_SPI.sh
...
#
# Usage        : FPGA_SPI.sh
#                FPGA_SPI.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FPGA_SPI.sh [-reset_run]
#                FPGA_SPI.sh [-reset_log]
#                FPGA_SPI.sh [-help]
#
...
# script info
echo -e "FPGA_SPI.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FPGA_SPI.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot FPGA_SPI xil_defaultlib.FPGA_SPI xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim FPGA_SPI -key {Behavioral:sim_1:Functional:FPGA_SPI} -tclbatch cmd.tcl -protoinst "protoinst_files/FPGA_SPI.protoinst" -protoinst "protoinst_files/design_2.protoinst" -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb FPGA_SPI.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./FPGA_SPI.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: FPGA_SPI.sh [-help]\n\
Usage: FPGA_SPI.sh [-step]\n\
Usage: FPGA_SPI.sh [-lib_map_path]\n\
Usage: FPGA_SPI.sh [-reset_run]\n\
Usage: FPGA_SPI.sh [-reset_log]\n\
Usage: FPGA_SPI.sh [-keep_index]\n\
Usage: FPGA_SPI.sh [-noclean_files]\n\n\
