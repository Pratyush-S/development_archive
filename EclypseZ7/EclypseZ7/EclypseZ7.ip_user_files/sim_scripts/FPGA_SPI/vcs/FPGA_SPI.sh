...
#                script (type 'FPGA_SPI.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.FPGA_SPI xil_defaultlib.glbl -o FPGA_SPI_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./FPGA_SPI_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key FPGA_SPI_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc FPGA_SPI_simv.daidir vcs_lib c.obj)
